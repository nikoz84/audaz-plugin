...
class Audaz_Construct
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Audaz_Construct_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct()
	{
		...
		$this->plugin_name = 'audaz-construct';
	 ...
	 *
	 * - Audaz_Construct_Loader. Orchestrates the hooks of the plugin.
	 * - Audaz_Construct_i18n. Defines internationalization functionality.
	 * - Audaz_Construct_Admin. Defines all hooks for the admin area.
	 * - Audaz_Construct_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Audaz_Construct_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
